...
public class PCNodeB {
    ...
    /**
     * Agrega un vecino usando el formato "ip_puerto".
     * Ejemplo válido: "172.16.2.5_5000"
     */
    public void agregarVecino(String vecino) {
        ...
        synchronized (vecinos) {
            if (!vecinos.contains(id)) {
                vecinos.add(id);
                System.out.println("[INFO] Vecino agregado: " + id);
            } else {
                System.out.println("[INFO] Vecino ya existía, ignorado: " + id);
            }
        }
    }
